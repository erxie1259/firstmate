...
- `bot-review-triage` - load when a PR wake, heartbeat review, or pre-merge check shows unresolved automated-reviewer comments such as coderabbitai's, and always before merging a PR that carries any.
